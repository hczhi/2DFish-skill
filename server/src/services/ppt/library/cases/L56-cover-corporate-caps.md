...
.l56-bg::after{content:"";position:absolute;inset:0;background:linear-gradient(92deg,rgba(250,248,244,.94) 0%,rgba(250,248,244,.84) 38%,rgba(250,248,244,.36) 64%,rgba(250,248,244,0) 84%)}
